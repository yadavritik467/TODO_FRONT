...
const Show = () => {
  ...
  const getAllPosts = async () => {
    try {
      setDataLoad(true);
      const { data } = await axios.get("https://todo-backend-three-sand.vercel.app/post/get");
  ...
  const create = async (e) => {
    ...
    try {
      if (auth.user === null) {
        ...
        setLoad(true);
      await axios.post("https://todo-backend-three-sand.vercel.app/post/post", {
        title,
        task,
        user: auth.user._id,
      });
  ...
  const editHandler = async () => {
    setUpdateLoad(true);
    const { data } = await axios.put(`https://todo-backend-three-sand.vercel.app/post/edit/${id}`, {
      title,
      task,
    });
    setTitle("");
  ...
  const deleteHandler = async (_id) => {
    try {
      await axios.delete(`https://todo-backend-three-sand.vercel.app/post/delete/${_id}`);
